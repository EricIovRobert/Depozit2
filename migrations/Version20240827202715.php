 ...
 */
final class Version20240827202715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE iesire (id INT AUTO_INCREMENT NOT NULL, produs_id INT NOT NULL, data DATE NOT NULL, nr_doc_iesire VARCHAR(255) NOT NULL, INDEX IDX_D1B67672C7FC4C39 (produs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE intrare (id INT AUTO_INCREMENT NOT NULL, produs_id INT NOT NULL, data DATE NOT NULL, nr_doc_intrare VARCHAR(255) NOT NULL, intrari INT NOT NULL, nefolosibile INT NOT NULL, INDEX IDX_151CB9CEC7FC4C39 (produs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
